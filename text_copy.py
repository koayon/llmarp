INSTRUCTION_COPY = """Pretend to be a Language Model.

Your aim is to predict the next token in the sequence of random text from the web or Wikipedia. The sequence will start empty and then you will be building up the sequence one word at a time.
...
Once you've tried it out a little and get the idea, try switching to a different language model on the left hand side of the screen.
The GPT-2 model allows you to see the attention patterns of the model as it makes it's predictions.
"""
